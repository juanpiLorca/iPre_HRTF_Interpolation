% HRTF interpolation.
% We are going to interpolate to a point that it is already in the dataset

% Righ channel: phi (elev) == 30° ; theta (azimuthal) == 60°
[y,Fs] = audioread("hrtf_dataset\elev30\R30e060a.wav"); 
...
% 
% bary_gains = HRTF_INTERPOLATION_IN_3D returns the interpolation weights 
% for 3-D interpolation of HRTF measurements.
% 
